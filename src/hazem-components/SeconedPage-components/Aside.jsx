    ...
    return (
        <div className="side-bar text-white w-full  md:w-3/12 bg-SectionAsideColor2 ">
            ...
            <div className="general pb-4">
                ...
                <ul>
                    <li className=" p-2  transition duration-500 hover:bg-gradient-to-l from-black to-gray-500 rounded-lg">{Data.secondPage.Aside.generaLi1?Data.secondPage.Aside.generaLi1:"Null"}</li>
                    <li className="p-2 transition duration-500 hover:bg-gradient-to-l from-black to-gray-500 rounded-lg"> {Data.secondPage.Aside.generaLi2?Data.secondPage.Aside.generaLi2:"Null"}</li>
                </ul>
            </div>
