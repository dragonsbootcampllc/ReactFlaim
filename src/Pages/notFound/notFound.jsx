...
const NotFound_page = () => {
  return (
    <div className="flex flex-col h-screen w-screen items-center text-center p-5 md:flex-row md:justify-around md:text-left lg:p-10 max-w-screen-2xl mx-auto bg-slate-100">
